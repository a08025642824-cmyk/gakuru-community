  ...
  return (
    <main className="max-w-4xl mx-auto p-8 mt-4">
      ...
      <div className="flex gap-5 sm:gap-8 mb-8 border-b-2 border-gray-100 overflow-x-auto scrollbar-hide">
        {/* 🌟 修正: href="/home/tab=..." を href="/home?tab=..." に変更 */}
        <Link 
          href="/home?tab=threads" 
      ...
      {currentTab === "threads" && (
        <>
          ...
          <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
            {/* 🌟 修正: カテゴリーのリンクもすべて /home から始まるように変更 */}
            <Link href="/home?tab=threads" className={`px-4 py-2 rounded-full text-sm font-bold transition whitespace-nowrap ${!currentCategory ? "bg-black text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`}>
              すべて
            </Link>
            <Link href="/home?tab=threads&category=tech" className={`px-4 py-2 rounded-full text-sm font-bold transition whitespace-nowrap ${currentCategory === "tech" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`}>
              💻 技術・プログラミング
            </Link>
            <Link href="/home?tab=threads&category=idea" className={`px-4 py-2 rounded-full text-sm font-bold transition whitespace-nowrap ${currentCategory === "idea" ? "bg-green-600 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`}>
              💡 アイデア・企画
            </Link>
            <Link href="/home?tab=threads&category=chat" className={`px-4 py-2 rounded-full text-sm font-bold transition whitespace-nowrap ${currentCategory === "chat" ? "bg-yellow-500 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`}>
              ☕️ 雑談
            </Link>
          </div>
