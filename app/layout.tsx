...
import MemoHeaderButton from "./components/MemoHeaderButton"; 
import ConditionalVisibility from "./components/ConditionalVisibility"; // 🌟 追加：表示切り替えラッパー
    ...
    <ClerkProvider>
      <html lang="ja">
        <body className={`${inter.className} bg-gray-50 text-gray-900 min-h-screen flex flex-col`}>
            ...
            <header className="bg-white border-b sticky top-0 z-50 shadow-sm">
              <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 sm:gap-8">
                  <Link href="/home" className="font-black text-lg sm:text-xl tracking-tighter text-black flex items-center gap-2 hover:opacity-80 transition">
          ...
          {/* 🌟 LPページではフッターも隠す（LP用のカッコいいデザインを後で置けるように） */}
          <ConditionalVisibility>
